// Daily Building — reads a feature about one poem each morning.
//
// The article is researched and written overnight by a Claude cloud routine (see routines/building.md
...
export default loom(async (ctx) => {
  ...
  name: 'Daily Building',
  description: 'A researched sheet about a building, written overnight and waiting each morning.',
