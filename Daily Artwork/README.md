...
A researched feature about one painting, written overnight and waiting on the phone each morning.
...
A routine runs at 04:00 and publishes `daily/artwork/<date>.json` to this repo (see
[`routines/artwork.md`](../routines/artwork.md)). The phone fetches it from
...
A `Today's artwork` notification fires once per article, scheduled for 07:00 so a 04:00 download does
not buzz at 04:00.
...
3. Add the widget: long-press home screen → **Loom → Daily Artwork**.
...
[`routines/artwork.md`](../routines/artwork.md) (voice, and what makes a painting worth a thousand words).
